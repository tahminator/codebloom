...
> = {
  ...
  MINIMUM_SPANNING_TREE: { name: "Minimum Spanning Tree", aliases: ["MST", "mst"] },
  ...
  DATABASE: { name: "Database", aliases: ["DB", "db"] },
  ...
  DYNAMIC_PROGRAMMING: { name: "Dynamic Programming", aliases: ["DP", "dp"] },
  ...
  BREADTH_FIRST_SEARCH: { name: "Breadth-First Search", aliases: ["BFS", "bfs"] },
  ...
  BINARY_SEARCH_TREE: { name: "Binary Search Tree", aliases: ["BST", "bst"] },
  TWO_POINTERS: { name: "Two Pointers"},
  ARRAY: { name: "Array" },
  DEPTH_FIRST_SEARCH: { name: "Depth-First Search", aliases: ["DFS", "dfs"] },
  EULERIAN_CIRCUIT: { name: "Eulerian Circuit" },
  TREE: { name: "Tree" },
  BINARY_SEARCH: { name: "Binary Search", aliases: ["BS", "bs"] },
