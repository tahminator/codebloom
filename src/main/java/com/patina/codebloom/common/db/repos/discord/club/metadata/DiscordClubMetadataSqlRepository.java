...
@Component
public class DiscordClubMetadataSqlRepository
    implements DiscordClubMetadataRepository {
    ...
    private DiscordClubMetadata parseResultSetToDiscordClubMetadata(
        final ResultSet rs
    ) throws SQLException {
        var id = rs.getString("id");
        var guildId = Optional.ofNullable(rs.getString("guildId"));
        var leaderboardChannelId = Optional.ofNullable(
            rs.getString("leaderboardChannelId")
        );
    ...
    @Override
    public void createDiscordClubMetadata(
        final DiscordClubMetadata discordClubMetadata
    ) {
        ...
        try (
            ...
            stmt.setString(
                "guildId",
                discordClubMetadata.getGuildId().orElse(null)
            );
            stmt.setString(
            ...
            stmt.setObject(
                "discordClubId",
                UUID.fromString(discordClubMetadata.getDiscordClubId())
            );

            stmt.executeUpdate();
        } catch (SQLException e) {
            throw new RuntimeException(
                "Failed to create DiscordClubMetadata",
                e
            );
        }
    }
    ...
    @Override
    public Optional<DiscordClubMetadata> getDiscordClubMetadataById(
        final String id
    ) {
        String sql = """
            SELECT
        ...
        try (
            ...
            throw new RuntimeException(
                "Failed to get DiscordClubMetadata by id",
                e
            );
        }
    ...
    @Override
    public boolean updateDiscordClubMetadata(
        final DiscordClubMetadata discordClubMetadata
    ) {
        String sql = """
            UPDATE
        ...
        try (
            ...
            throw new RuntimeException(
                "Failed to update DiscordClubMetadata",
                e
            );
        }
    }
    ...
    public boolean deleteDiscordClubMetadataById(final String id) {
        ...
        try (
            ...
            throw new RuntimeException(
                "Failed to delete DiscordClubMetadata by id",
                e
            );
        }
    }
    ...
    @Override
    public Optional<DiscordClubMetadata> getDiscordClubMetadataByClubId(
        final String id
    ) {
        String sql = """
            SELECT
