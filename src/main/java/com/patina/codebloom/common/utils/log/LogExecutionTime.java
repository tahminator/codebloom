 ...
 *
 * <p>When applied to a method, logs the execution time to SLF4J by default. Optionally, if {@code reportToDiscord} is
 * set to {@code true}, the execution time will also be reported to Discord for monitoring purposes.
 *
 * <p><b>Example usage:</b>
 *
 * <pre>{@code
