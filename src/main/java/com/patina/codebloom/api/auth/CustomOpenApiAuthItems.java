...
public class CustomOpenApiAuthItems {
    private static PathItem discordOAuthFlow = new PathItem().get(new io.swagger.v3.oas.models.Operation().addTagsItem("Authentication Routes")
    ...
    private static PathItem discordOAuthFlowCallback = new PathItem().get(new io.swagger.v3.oas.models.Operation()
            .addTagsItem("Authentication Routes").summary("Discord OAuth authentication flow callback").description("""
                    ...
                    """).responses(
                    new ApiResponses().addApiResponse("302", new ApiResponse().description("Redirect to `/dashboard` on successful authentication."))
