...
import com.patina.codebloom.website.leetcode.client.models.LeetcodeLang;
...
import com.patina.codebloom.website.leetcode.client.queries.GetPotd;
import com.patina.codebloom.website.leetcode.client.queries.GetSubmissionDetails;
import com.patina.codebloom.website.leetcode.client.queries.GetUserProfile;
import com.patina.codebloom.website.leetcode.client.queries.SelectAcceptedSubmisisonsQuery;
import com.patina.codebloom.website.leetcode.client.queries.SelectProblemQuery;
import com.patina.codebloom.website.leetcode.models.QuestionDifficulty;
import com.patina.codebloom.website.leetcode.routines.LeetcodeTokenRoutine;
...
public class LeetcodeApiClientImpl implements LeetcodeApiClient {
    ...
    public LeetcodeQuestion findQuestionBySlug(final String slug) {
        ...
        try {
            RequestSpecification reqSpec = RestAssured.given().header("Content-Type", "application/json")
                            .header("Referer", "https://leetcode.com").body(requestBody);
    ...
    public LeetcodeDetailedQuestion findSubmissionDetailBySubmissionId(final int submissionId) {
        ...
        try {
            RequestSpecification reqSpec = RestAssured.given().header("Content-Type", "application/json")
                            ...
                            .cookie("LEETCODE_SESSION=" + LeetcodeTokenRoutine.getCookie() + ";").body(requestBody);
            Response response = reqSpec.post(endpoint);
            ...
            LeetcodeLang lang = (langName != null && langVerboseName != null) ? new LeetcodeLang(langName, langVerboseName) : null;

            LeetcodeDetailedQuestion question = new LeetcodeDetailedQuestion(runtime, runtimeDisplay, runtimePercentile, memory,
                            memoryDisplay, memoryPercentile, code, lang);
    ...
    @Override
    public LeetcodeUserProfile getUserProfile(final String username) {
        String endpoint = "https://leetcode.com/graphql";
        ...
        try {
            ...
            return new LeetcodeUserProfile(returedUsername, ranking, userAvatar, realName, aboutMe);
        } catch (Exception e) {
            throw new RuntimeException("Error fetching the API", e);
        }
    }
