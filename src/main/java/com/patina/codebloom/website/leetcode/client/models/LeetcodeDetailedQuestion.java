...
public class LeetcodeDetailedQuestion {
    ...
    private String code;
    private LeetcodeLang lang;

    public LeetcodeDetailedQuestion(final int runtime, final String runtimeDisplay, final float runtimePercentile, final int memory,
                    final String memoryDisplay, final float memoryPercentile,
                    final String code, final LeetcodeLang lang) {
    ...
    public LeetcodeLang getLang() {
        return lang;
    }

    public void setLang(final LeetcodeLang lang) {
        this.lang = lang;
    }
}
