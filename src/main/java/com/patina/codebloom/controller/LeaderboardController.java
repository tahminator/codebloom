...
import com.patina.codebloom.models.leaderboard.Leaderboard;
import com.patina.codebloom.models.leaderboard.LeaderboardWithUsers;
import com.patina.codebloom.models.user.UserWithScore;
import com.patina.codebloom.repos.leaderboard.LeaderboardRepository;
...
public class LeaderboardController {
    ...
    @GetMapping("/current")
    @Operation(summary = "Fetch the currently active leaderboard data, attaching the users for each leaderboard.", responses = { @ApiResponse(responseCode = "200"),
            @ApiResponse(responseCode = "401", description = "Not authenticated", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))) })
    ...
    @Operation(summary = "Unprotected route that fetches the currently active leaderboard data, attaching only the top 5 users for each leaderboard.", responses = { @ApiResponse(responseCode = "200"),
            @ApiResponse(responseCode = "401", description = "Not authenticated", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))) })
    ...
    @Operation(summary = "Fetch the specific user data in the currently active leaderboard data.", responses = { @ApiResponse(responseCode = "200"),
            @ApiResponse(responseCode = "401", description = "Not authenticated", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))) })
    public ResponseEntity<ApiResponder<UserWithScore>> getUserCurrentLeaderboardFull(final HttpServletRequest request, @PathVariable final String userId) {
        FakeLag.sleep(650);
    ...
    @Operation(description = "", responses = { @ApiResponse(responseCode = "200"),
            ...
            @ApiResponse(responseCode = "401", description = "Not authenticated", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))) })
    public ResponseEntity<ApiResponder<LeaderboardWithUsers>> getLeaderboardByIdFull(final HttpServletRequest request, @PathVariable final String leaderboardId) {
        FakeLag.sleep(800);
    ...
    @Operation(summary = "Fetch the user data in the current leaderboard.", responses = { @ApiResponse(responseCode = "200"),
            @ApiResponse(responseCode = "404", description = "Leaderboard not found", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))),
            @ApiResponse(responseCode = "401", description = "Not authenticated", content = @Content(schema = @Schema(implementation = UnsafeGenericFailureResponse.class))) })
    public ResponseEntity<ApiResponder<UserWithScore>> getUserByLeaderboardById(final HttpServletRequest request, @PathVariable final String leaderboardId, @PathVariable final String userId) {
        FakeLag.sleep(650);
