...
public class UserControllerTest {
    ...
    private Question createRandomQuestion(final String userId) {
        return Question.builder()
                ...
                .questionDifficulty(com.patina.codebloom.common.db.models.question.QuestionDifficulty.Medium)
                .pointsAwarded(10)
    ...
    void getSubmissionsReturnsSuccessfullyNoFilters() {
        ...
        when(questionTopicService.stringsToEnums(any()))
                .thenReturn(new com.patina.codebloom.common.db.models.question.topic.LeetcodeTopicEnum[0]);
